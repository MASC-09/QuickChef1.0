...
namespace QuickChef1._0.Controllers
{
    public class AdminFacturasController : Controller
    {
        ...
        // GET: AdminFacturas/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: AdminFacturas/Create
